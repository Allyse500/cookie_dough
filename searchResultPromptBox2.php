            ...
            <div id="publicRecipesList">
                ...
                <?php
                        foreach ($publicRecipeTitles as $value) {
                            echo "<form class='recipeOpt' action='includes/loadPublicRecipe2.inc.php' method='POST'><input style='display:none;' id='recipeInputName' name ='publicRecipeInput' value='" . $value["publicRecipeID"] . "'><button name='loadRecipe' class='recipeOptBtn'>". $value["publicRecipesUserName"] . ": ". $value["publicRecipesTitle"] . "</button></form>";
                        }     
                    ?>
